...
30. 请问 sstable 中存储的是 key-value 吗？有关版本信息有没有存储？min_version, max_version 有没有存储？
    第二次启动时，读取 sstable 时，怎么得到 min_version, max_version 的数据？
    第二次启动时，读取 sstable 时，version_data_ 的数据能得到吗？

31. garbage collection 就是将 memtable 和 mvccsstable 中的 小于指定版本的数据清掉